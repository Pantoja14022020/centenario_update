...
namespace SIIGPP.PI.Models.InformacionJuridico.Arrestos
{
    public class ArrestoViewModel
    {
        public Guid IdArresto { get; set; }
        public Guid ModuloServicioId { get; set; }
        public string FechaRecibido { get; set; }
        public string Oficio { get; set; }
        public string CausaPenal { get; set; }
        public string NomArrestado { get; set; }
        public string TiempoH { get; set; }
        public string JuezSolicita { get; set; }
        public string GpoAsignado { get; set; }
