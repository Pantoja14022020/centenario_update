...
## Construir imagen
1. docker build --isolation=hyperv -t panel-control-img-prod-ws .
## Levantar contenedor
2. docker run --isolation=hyperv -p 5006:5006 --name panel-control-container-prod-ws panel-control-img-prod-ws
## Eliminar volumenes
...
1. docker build -f Dockerfile.linux -t siigpp-pc-img-prod-linux .

# LEVANTAR EL CONTENEDOR
2. docker run -d -p 5006:5006 --name siigpp-pc-container-prod-linux siigpp-pc-img-prod-linux
...
# CREAR LA IMAGEN, EN LA TERMINAL INGRESAR
1. docker build -f Dockerfile.dev.linux -t siigpp-pc-dev-linux .

# EJECUTAR CONTENEDOR EN UN ENTORNO LOCAL
2. docker run -it -v "$PWD":/app -p 5006:5006 --name siigpp-pc-dev-linux siigpp-pc-dev-linux
...
# CREAR LA IMAGEN, EN LA TERMINAL INGRESAR
1. docker build -f Dockerfile.dev.ws -t siigpp-pc-dev-ws .

# EJECUTAR CONTENEDOR EN UN ENTORNO LOCAL modo Hot Reload
2. docker run -it --mount type=bind,source="<Ruta donde se encuentra tu carpeta de proyecto>",target="C:\app" -p 5006:5006 --name siigpp-pc-dev-ws siigpp-pc-dev-ws

Ejemplo:

    docker run -it --mount type=bind,source="C:\Users\Administrator\Desktop\panel-control-cent-microservice",target="C:\app" -p 5006:5006 --name siigpp-pc-dev-ws siigpp-pc-dev-ws
...
1. dotnet restore "SIIGPP.PC.csproj"
2. dotnet clean "SIIGPP.PC.csproj"
...
System.IO.DirectoryNotFoundException: 'C:\ruta\panel-control-cent-microservice\bin\Debug\net9.0\Carpetas\'
