...
Ejemplo:
    ...
    docker run -it --mount type=bind,source="C:\Users\Administrator\Desktop\conf-cent-microservice",target="C:\app" -p 44360:44360 --name siigpp-conf-dev-ws siigpp-conf-dev-ws
