...
## Construir imagen
1. docker build --isolation=hyperv -t investigacion-litigacion-img-prod-ws .
## Levantar contenedor
2. docker run --isolation=hyperv -p 44312:44312 --name investigacion-litigacion-container-prod-ws investigacion-litigacion-img-prod-ws
## Eliminar volumenes
...
1. docker build -f Dockerfile.linux -t siigpp-il-img-prod-linux .

# LEVANTAR EL CONTENEDOR
2. docker run -d -p 44312:44312 --name siigpp-il-container-prod-linux siigpp-il-img-prod-linux
...
# CREAR LA IMAGEN, EN LA TERMINAL INGRESAR
1. docker build -f Dockerfile.dev.linux -t siigpp-il-dev-linux .

# EJECUTAR CONTENEDOR EN UN ENTORNO LOCAL
2. docker run -it -v "$PWD":/app -p 44312:44312 --name siigpp-il-dev-linux siigpp-il-dev-linux
...
# CREAR LA IMAGEN, EN LA TERMINAL INGRESAR
1. docker build -f Dockerfile.dev.ws -t siigpp-il-dev-ws .

# EJECUTAR CONTENEDOR EN UN ENTORNO LOCAL modo Hot Reload
2. docker run -it --mount type=bind,source="<Ruta donde se encuentra tu carpeta de proyecto>",target="C:\app" -p 44312:44312 --name siigpp-il-dev-ws siigpp-il-dev-ws

Ejemplo:

    docker run -it --mount type=bind,source="C:\Users\Administrator\Desktop\invest-litig-cent-microservice",target="C:\app" -p 44312:44312 --name siigpp-il-dev-ws siigpp-il-dev-ws
...
1. dotnet restore "SIIGPP.IL.csproj"
2. dotnet clean "SIIGPP.IL.csproj"
...
System.IO.DirectoryNotFoundException: 'C:\ruta\invest-litig-cent-microservice\bin\Debug\net9.0\Carpetas\'
