##################################
# INSTALAR ENTORNO EN WINDOWS SERVER  #
##################################
...
## Construir imagen
1. docker build --isolation=hyperv -t centro-at-img-prod-ws .
## Levantar contenedor
2. docker run --isolation=hyperv -p 44394:44394 --name centro-at-container-prod-ws centro-at-img-prod-ws
## Eliminar volumenes
...
1. docker build -f Dockerfile.linux -t siigpp-cat-img-prod-linux .

# LEVANTAR EL CONTENEDOR
2. docker run -d -p 44394:44394 --name siigpp-cat-container-prod-linux siigpp-cat-img-prod-linux
...
# CREAR LA IMAGEN, EN LA TERMINAL INGRESAR
1. docker build -f Dockerfile.dev.linux -t siigpp-cat-dev-linux .

# EJECUTAR CONTENEDOR EN UN ENTORNO LOCAL
2. docker run -it -v "$PWD":/app -p 44394:44394 --name siigpp-cat-dev-linux siigpp-cat-dev-linux
...
# CREAR LA IMAGEN, EN LA TERMINAL INGRESAR
1. docker build -f Dockerfile.dev.ws -t siigpp-cat-dev-ws .

# EJECUTAR CONTENEDOR EN UN ENTORNO LOCAL modo Hot Reload
2. docker run -it --mount type=bind,source="<Ruta donde se encuentra tu carpeta de proyecto>",target="C:\app" -p 44394:44394 --name siigpp-cat-dev-ws siigpp-cat-dev-ws

Ejemplo:

    docker run -it --mount type=bind,source="C:\Users\Administrator\Desktop\cat-cent-microservice",target="C:\app" -p 44394:44394 --name siigpp-cat-dev-ws siigpp-cat-dev-ws
...
1. dotnet restore "SIIGPP.CAT.csproj"
2. dotnet clean "SIIGPP.CAT.csproj"
...
System.IO.DirectoryNotFoundException: 'C:\ruta\centro-atmp-cent-microservice\bin\Debug\net9.0\Carpetas\'
