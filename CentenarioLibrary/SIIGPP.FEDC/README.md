...
## Construir imagen
1. docker build --isolation=hyperv -t fiscalia-dcorrupcion-img-prod-ws .
## Levantar contenedor
2. docker run --isolation=hyperv -p 44348:44348 --name fiscalia-dcorrupcion-container-prod-ws fiscalia-dcorrupcion-img-prod-ws
## Eliminar volumenes
...
1. docker build -f Dockerfile.linux -t siigpp-fedc-img-prod-linux .

# LEVANTAR EL CONTENEDOR
2. docker run -d -p 44348:44348 --name siigpp-fedc-container-prod-linux siigpp-fedc-img-prod-linux
...
# CREAR LA IMAGEN, EN LA TERMINAL INGRESAR
1. docker build -f Dockerfile.dev.linux -t siigpp-fedc-dev-linux .

# EJECUTAR CONTENEDOR EN UN ENTORNO LOCAL
2. docker run -it -v "$PWD":/app -p 44348:44348 --name siigpp-fedc-dev-linux siigpp-fedc-dev-linux
...
# CREAR LA IMAGEN, EN LA TERMINAL INGRESAR
1. docker build -f Dockerfile.dev.ws -t siigpp-fedc-dev-ws .

# EJECUTAR CONTENEDOR EN UN ENTORNO LOCAL modo Hot Reload
2. docker run -it --mount type=bind,source="<Ruta donde se encuentra tu carpeta de proyecto>",target="C:\app" -p 44348:44348 --name siigpp-fedc-dev-ws siigpp-fedc-dev-ws

Ejemplo:

    docker run -it --mount type=bind,source="C:\Users\Administrator\Desktop\fsclia-delitscorrup-cent-microservice",target="C:\app" -p 44348:44348 --name siigpp-fedc-dev-ws siigpp-fedc-dev-ws
...
1. dotnet restore "SIIGPP.FEDC.csproj"
2. dotnet clean "SIIGPP.FEDC.csproj"
...
System.IO.DirectoryNotFoundException: 'C:\ruta\fsclia-delitscorrup-cent-microservice\bin\Debug\net9.0\Carpetas\'
