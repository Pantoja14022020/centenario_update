...
namespace SIIGPP.SP.Controllers
{
    ...
    [ApiController]
    public class DocsDiligenciasController : ControllerBase
    {
        private readonly DbContextSIIGPP _context;
        private readonly IWebHostEnvironment _environment;

        public DocsDiligenciasController(DbContextSIIGPP context, IWebHostEnvironment environment)
        {
            _context = context;
        ...
        public async Task<IEnumerable<DocsDiligenciasViewModel>> Listar([FromRoute]Guid idrdiligencias)
        {
            var docs = await _context.DocsDiligencias
                .Where(a => a.RDiligenciasId == idrdiligencias)
                .Include(a => a.RDiligencias)
                .ToListAsync();

            return docs.Select(a => new DocsDiligenciasViewModel
            {
                 IdDocsDiligencia = a.IdDocsDiligencia,
        ...
        public async Task<IActionResult> Crear([FromBody] CrearViewModel model)
        {
            ...
            DocsDiligencia docss = new DocsDiligencia();
            try
            {
            ...
            {
                 docss = new DocsDiligencia
                 {


                    RDiligenciasId = Guid.Parse(idnuevo[i]),
                    ...
                    _context.DocsDiligencias.Add(docss);
